...
var applyForJob_exports = {};
__export(applyForJob_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(applyForJob_exports);
...
var handler = async (event) => {
  try {
    ...
    return result ? { statusCode: 201, body: JSON.stringify(result) } : { statusCode: 404, body: JSON.stringify({ error: "Job not found" }) };
  } catch (err) {
    return {
      statusCode: 500,
