...
async function registerStudent(id, studentId) {
  ...
  const alreadyRegistered = (placement.registered || []).some(
    (r5) => String(r5.student) === String(studentId) || r5.student && String(r5.student.id) === String(studentId)
  );
...
var handler = async (event) => {
  ...
  try {
    ...
    console.error("\u274C Error registering student:", err2);
    ...
    return createResponse(500, { message: "Server error registering student", error: err2.message });
  }
};
export {
  handler
