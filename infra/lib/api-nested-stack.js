...
class ApiNestedStack extends cdk.NestedStack {
  constructor(scope, id, props) {
    ...
    jobId.addResource("status").addMethod("PATCH", new apigateway.LambdaIntegration(lambdas.updateJobStatusLambda));
    jobId.addResource("apply").addMethod("POST", new apigateway.LambdaIntegration(lambdas.applyForJobLambda));
    ...
    placementId.addResource("register").addMethod("POST", new apigateway.LambdaIntegration(lambdas.registerStudentPlacementLambda));
    placementId.addResource("status").addMethod("PUT", new apigateway.LambdaIntegration(lambdas.updateStudentStatusLambda));
    placementId.addResource("students").addMethod("GET", new apigateway.LambdaIntegration(lambdas.getPlacementStudentsLambda));
    ...
    forgotRes.addResource("request").addMethod("POST", new apigateway.LambdaIntegration(lambdas.forgotPasswordRequestLambda));
    forgotRes.addResource("verify").addMethod("POST", new apigateway.LambdaIntegration(lambdas.forgotPasswordVerifyLambda));
    forgotRes.addResource("reset").addMethod("POST", new apigateway.LambdaIntegration(lambdas.forgotPasswordResetLambda));
    ...
    // User-specific endpoints under /user/{id}/
