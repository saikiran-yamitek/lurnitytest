...
async function listPlacements() {
  const command = new ScanCommand2({ TableName: TABLE_NAME });
...
var handler = async (event) => {
  ...
  try {
    ...
    console.error("\u274C Error listing placements:", err2);
    ...
    return createResponse(500, { message: "Server error listing placements", error: err2.message });
  }
};
export {
  handler
