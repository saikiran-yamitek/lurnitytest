...
// ../backend/models/Transcribe.js
var transcribe = new AWS.TranscribeService({ region: "ap-south-1" });
async function transcribeMedia(url) {
...
// ../backend/routes/transcribe/transcribe.js
