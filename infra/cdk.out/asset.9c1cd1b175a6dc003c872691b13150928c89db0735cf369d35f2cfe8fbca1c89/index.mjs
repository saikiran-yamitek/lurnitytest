...
var handler = async (event) => {
  ...
  try {
    ...
    console.error("\u274C Error updating student status:", err2);
    ...
    return createResponse(500, { message: "Server error updating student status", error: err2.message });
  }
};
export {
  handler
